...
function woostify_sites_local_import_files() {
	return array(
		array(
			...
			'preview_url'                  => 'https://woostify.com/demos/fashion1/',
			'homepage'                     => 'Fashion',
			'blog_page'                    => 'Blog',
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately.', 'woostify' ),
			'preview_url'                  => 'https://woostify.com/demos/fashion2/',
			'homepage'                     => 'Woostify',
			'blog_page'                    => 'Blog',
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately.', 'woostify' ),
			'preview_url'                  => 'https://woostify.com/demos/fashion3',
			'homepage'                     => 'Woostify',
			'blog_page'                    => 'Blog',
			'primary_menu'                 => 'Primary Menu',
			'footer_menu'                  => 'Footer Menu',
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately.', 'woostify' ),
			'preview_url'                  => 'https://woostify.com/demos/fashion4/',
			'homepage'                     => 'Woostify',
			'blog_page'                    => 'Blog',
			'primary_menu'                 => 'Primary Menu',
			'footer_menu'                  => 'Footer Menu',
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately.', 'woostify' ),
			'preview_url'                  => 'https://woostify.com/demos/shoebox/',
			'homepage'                     => 'Woostify',
			'blog_page'                    => 'Blog',
			'primary_menu'                 => 'Primary Menu',
			'footer_menu'                  => 'Footer Menu',
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately.', 'woostify' ),
			'preview_url'                  => 'https://woostify.com/demos/cosmetica',
			'homepage'                     => 'Woostify',
			'blog_page'                    => 'Blog',
			'primary_menu'                 => 'Primary Menu',
			'footer_menu'                  => 'Footer Menu',
		...
		array(
			...
			'preview_url'                  => 'https://woostify.com/demos/ankle',
			'homepage'                     => 'Homepage',
			'blog_page'                    => 'Blog',
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you should update permalink.', 'woostify' ),
			'preview_url'                  => 'https://woostify.com/demos/petz',
			'homepage'                     => 'Woostify',
			'blog_page'                    => 'Blog',
			'primary_menu'                 => 'Primary Menu',
			'footer_menu'                  => 'Footer Menu',
